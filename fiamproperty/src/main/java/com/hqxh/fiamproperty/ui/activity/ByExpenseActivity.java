 ...
 * 备用金报销明细
 **/
public class ByExpenseActivity extends BaseTitleActivity {

    private static final String TAG = "ByExpenseActivity";
    ...
    private TextView paycheckcostText; //验收金额
    private TextView enterbyText; //报销人
    private TextView departmentText; //部门
    private TextView crewText; //科室
    private TextView enterdateText; //报销日期
    private TextView contractvendorText; //供应商
    private TextView payvendorText; //收款单位
    private TextView address1Text; //收款单位地址
    private TextView bankText; //开户行
    private TextView bankaccountText; //账号


    private ImageView jkdImageView; //借款单
    private ImageView fkysdImageView; //付款验收单
    private ImageView bxmxImageView; //报销明细
    ...
    protected int getContentViewLayoutID() {
        return R.layout.activity_by_expense;
    }
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        paycheckcostText = (TextView) findViewById(R.id.paycheckcost_text_id);
        enterbyText = (TextView) findViewById(R.id.enterby_text_id);
        departmentText = (TextView) findViewById(R.id.department_text_id);
        crewText = (TextView) findViewById(R.id.crew_text_id);
        enterdateText = (TextView) findViewById(R.id.enterdate_text_id);
        contractvendorText = (TextView) findViewById(R.id.contractvendor_text_id);
        ...
        jkdImageView = (ImageView) findViewById(R.id.jkd_image_id);
        fkysdImageView = (ImageView) findViewById(R.id.fkysd_imageview_id);
        bxmxImageView = (ImageView) findViewById(R.id.bxmx_text_id);
    ...
    private void showData() {
        ...
        enterdateText.setText(JsonUnit.strToDateString(JsonUnit.convertStrToArray(expense.getENTERDATE())[0]));
        contractvendorText.setText(JsonUnit.convertStrToArray(expense.getCONTRACTVENDOR())[0]);
        payvendorText.setText(JsonUnit.convertStrToArray(expense.getPAYVENDOR())[0]);
        address1Text.setText(JsonUnit.convertStrToArray(expense.getADDRESS1())[0]);
        bankText.setText(JsonUnit.convertStrToArray(expense.getBANK())[0]);
        bankaccountText.setText(JsonUnit.convertStrToArray(expense.getBANKACCOUNT())[0]);
        ...
        fkysdImageView.setOnClickListener(fkysdImageViewOnClickListener);
        bxmxImageView.setOnClickListener(bxmxImageViewOnClickListener);
    ...
    protected String getSubTitle() {
        return getString(R.string.byjbxmx_text);
    }
    ...
    private View.OnClickListener jkdImageViewOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            Intent intent = new Intent(ByExpenseActivity.this, BorelationActivity.class);
    ...
    //付款验收
    private View.OnClickListener fkysdImageViewOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            Intent intent = new Intent(ByExpenseActivity.this, PaycheckrelationActivity.class);
            intent.putExtra("appid", GlobalConfig.EXPENSE_APPID);
            intent.putExtra("expensenum", JsonUnit.convertStrToArray(expense.getEXPENSENUM())[0]);
            startActivityForResult(intent, 0);
        }
    ...
    //报销明细
    private View.OnClickListener bxmxImageViewOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            Intent intent = new Intent(ByExpenseActivity.this, ExpenselineActivity.class);
            intent.putExtra("expensenum", JsonUnit.convertStrToArray(expense.getEXPENSENUM())[0]);
            intent.putExtra("appid", GlobalConfig.EXPENSE_APPID);
            startActivityForResult(intent, 0);
        }
    ...
    private View.OnClickListener sqjlImageViewOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            Intent intent = new Intent(ByExpenseActivity.this, WftransactionActivity.class);
        ...
        Rx2AndroidNetworking.post(GlobalConfig.HTTP_URL_START_WORKFLOW)
                ...
                .subscribe(new Consumer<String>() {
                    ...
                    public void accept(@NonNull Throwable throwable) throws Exception {
                        showMiddleToast(ByExpenseActivity.this, getString(R.string.spsb_text));
                    }
                });
    }
    ...
    private void getNetWorkEXPENSE() {
        ...
        String data = HttpManager.getEXPENSEUrl(appid, ownernum, AccountUtils.getpersonId(ByExpenseActivity.this), 1, 10);
