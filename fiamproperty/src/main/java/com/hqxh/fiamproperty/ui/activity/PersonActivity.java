...
public class PersonActivity extends BaseListActivity {
    ...
    protected String getSubTitle() {
        ...
        return getResources().getString(R.string.ownername_text);
    ...
    private void getData() {
        String data = HttpManager.getPERSONUrl(cudept, cucrew, AccountUtils.getpersonId(this), curpage, showcount);
        Log.e(TAG,"data="+data);
        Rx2AndroidNetworking.post(GlobalConfig.HTTP_URL_SEARCH)
                ...
                .doOnNext(new Consumer<R_ZXPERSON>() {
                    @Override
                    public void accept(@NonNull R_ZXPERSON r_person) throws Exception {
                    }
                })
                ...
                .map(new Function<ResultBean, List<PERSION>>() {
                    @Override
                    public List<PERSION> apply(@NonNull ResultBean resultbean) throws Exception {
                ...
                .subscribe(new Consumer<List<PERSION>>() {
                    @Override
                    public void accept(@NonNull List<PERSION> cudept) throws Exception {
    ...
    protected void fillData() {
        ...
        initAdapter(new ArrayList<PERSION>());
        getData();
     ...
     * 获取数据*
     */
    private void initAdapter(final List<PERSION> list) {
     ...
     * 添加数据*
     */
    private void addData(final List<PERSION> list) {
